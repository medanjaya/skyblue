                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      detail['price_info']?[0]['current_price'] != null
                                      ? 'Rp. ${
                                      NumberFormat.decimalPattern('id_ID')
                                        .format(
                                          detail['price_info']![0]['current_price'] *
                                          order['model_quantity_purchased']
                                        )
                                        .toString()
                                      }'
                                      : '',
                              ...
                              IconButton(
                                onPressed: () {
                                  ...
                                  setState(
                                    () {
                                      orders[i]['model_quantity_purchased'] = quantity <
                            ...
                            .format(
                              orders.fold<num>(
                                ...
                                (v, i) {
                                  return v +
                                  (
                                    i['item']['price_info']?[0]['current_price'] *
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        sb.from('order').insert(
                          {
                            'source': 'local',
                            'buyer_username': name.text,
                            ...
                            'create_time': DateTime.now().millisecondsSinceEpoch ~/ Duration.millisecondsPerSecond,
                          },
                        )
                        .select()
                        .then(
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Padding(
                                  ...
                                  child: Text('Transaksi ${r.first['order_sn']} berhasil dibuat.'),
                                ),
